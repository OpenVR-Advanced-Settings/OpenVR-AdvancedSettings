...
public:
	...
	virtual void setPlaybackDevice(const std::string& id, bool notify = true) = 0;
	virtual std::string getPlaybackDevName() = 0;
	virtual std::string getPlaybackDevId() = 0;

	virtual void setMirrorDevice(const std::string& id, bool notify = true) = 0;
	...
	virtual std::vector<std::pair<std::string, std::string>> getRecordingDevices() = 0;
	virtual std::vector<std::pair<std::string, std::string>> getPlaybackDevices() = 0;
};
