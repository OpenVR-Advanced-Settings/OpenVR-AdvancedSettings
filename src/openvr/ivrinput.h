...
namespace action_keys
{
    ...
    constexpr auto addAutoAlignPointLeft = "/actions/motion/in/AddAutoAlignPointLeft";
    constexpr auto addAutoAlignPointRight = "/actions/motion/in/AddAutoAlignPointRight";
